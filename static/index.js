...
function askBot() {
    ...
    $("send_button").click(function () {
        ...
        var user_bot_input_text = $("bot__messages").val()

        if (user_bot_input_text != "btn") {
           
            //  add a new div element in the chat window
            $("chatbox__chat").append('<div class="user__messages">' + user_bot_input_text + ' </div>')
            
            //Clear the text input box after sending message
            $("col-9 text-left chatbox__input").val('Type your message here...');
